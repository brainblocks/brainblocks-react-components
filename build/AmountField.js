  ...
  function(e, t, r) {
    ...
    var a = function(e) {
        ...
        function u(e, r) {
          ...
          var f = (function e(r, s, u, f, d) {
            for (
              ...
              if (
                ...
                if (
                  z === D &&
                  (0 < F && (L = L.replace(c, '')), 0 < L.trim().length)
                ) {
                  switch (p) {
                    case 32:
                    case 9:
                ...
                switch (p) {
                  case 123:
                    for (
                      h = (L = L.trim()).charCodeAt(0), y = 1, W = ++z;
                      z < V;
                    ...
                    switch (
                      ((y = u.substring(W, z)),
                      0 === h &&
                        (h = (L = L.replace(l, '').trim()).charCodeAt(0)),
                      h)
                    ) {
                      case 64:
                        switch (
                  ...
                  case 59:
                    if (
                      1 <
                      (W = (L = (0 < F ? L.replace(c, '') : L).trim()).length)
                    )
                      switch (
                        (0 === T &&
                          ((h = L.charCodeAt(0)),
                        ...
                        0 < E &&
                          void 0 !==
                            (k = a(1, L, s, r, P, _, B.length, f, d, f)) &&
                          0 === (W = (L = k.trim()).length) &&
                          (L = '\0\0'),
                        (h = L.charCodeAt(0)),
                        (p = L.charCodeAt(1)),
                        ...
                        default:
                          58 !== L.charCodeAt(W - 1) &&
                            (B += n(L, h, p, L.charCodeAt(2)))
                      }
                    ;(I = F = T = h = 0), (L = ''), (p = u.charCodeAt(++z))
                }
              }
              switch (p) {
                case 13:
                case 10:
                  47 === w
                    ...
                    : 0 === 1 + h &&
                      ...
                      0 < L.length &&
                      ((F = 1), (L += '\0')),
                    0 < E * N && a(0, L, s, r, P, _, B.length, f, d, f),
                    (_ = 1),
                    P++
                  break
                case 59:
            ...
            if (0 < (W = B.length)) {
              if (
                ((F = s),
                0 < E &&
                  void 0 !== (k = a(2, B, F, r, P, _, W, f, d, f)) &&
                  0 === (B = k).length)
              )
                return H + B + G
              if (((B = F.join(',') + '{' + B + '}'), 0 != M * C)) {
                switch ((2 !== M || i(B, 2) || (C = 0), C)) {
                  case 111:
          ...
          return (
            0 < E &&
              void 0 !== (u = a(-2, f, s, s, P, _, f.length, 0, 0, 0)) &&
              (f = u),
            (C = 0),
            (_ = P = 1),
            f
...
*/
  ...
  function(e, t, r) {
    ...
    var C = function() {
      return {
        plugins: [
          ...
          k()(),
          w()(),
          'undefined' == typeof window ? null : j()(),
          P()()
        ]
      }
    }
        ...
        class p extends u.a.Component {
          constructor(e, t) {
            ...
            r &&
              ...
              (this.theme = h ? E.a.initial(t) || H : G),
              this.attach(this.theme),
              (this.cacheClasses = { value: null, lastProp: null, lastJSS: {} })
          }
          componentDidMount() {
            h &&
              (this.unsubscribeId = E.a.subscribe(this.context, e => {
                const t = this.theme
                ;(this.theme = e),
                  this.attach(this.theme),
                  this.setState({}, () => {
          ...
          componentWillUnmount() {
            this.detach(this.theme),
              null !== this.unsubscribeId &&
                E.a.unsubscribe(this.context, this.unsubscribeId)
          }
          getClasses() {
    ...
    h.ponyfillGlobal.__MUI_STYLES__ || (h.ponyfillGlobal.__MUI_STYLES__ = {}),
      h.ponyfillGlobal.__MUI_STYLES__.withStyles ||
        (h.ponyfillGlobal.__MUI_STYLES__.withStyles = U)
    t.a = (e, t) =>
  ...
  function(e, t, r) {
    ...
    function z(...e) {
      return [
        ...
        `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${T})`
      ].join(',')
    }
    var F = [
      'none',
    ...
    t.a = function(e = {}) {
      ...
      return i()(
        ...
        u()({ shape: I, spacing: v, transitions: V.a, zIndex: D }, h, {
  ...
  function(e, t, r) {
    ...
    var u = function(e) {
      var t = e.styles,
        r = e.children,
        i = (e.size, e.iconSize, e.disabled),
        u = void 0 !== i && i,
        l = (e.block, e.el),
        c = void 0 === l ? 'button' : l,
        f = (e.variant, e.destyleMerge, e.destyleNames, e.loading),
        d = void 0 !== f && f,
        h = s(e, [
          'styles',
          'children',
      ...
      return (
        ...
        n.createElement(
          p,
          a({ className: t.root, disabled: u }, h),
          n.createElement('span', { className: t.children }, r),
          d &&
            n.createElement(
              'span',
    ...
    t.default = Object(i.destyle)(u, 'BB-Button')
  },
  function(e, t, r) {
    'use strict'
    r.r(t),
      r.d(t, 'FormField', function() {
        return a
      })
    var n = r(0),
      i = r(8)
    ...
    var a = function(e) {
      ...
      return n.createElement(
        'div',
        { className: t.root },
        !!i && n.createElement('div', { className: t.adornStart }, i),
        r,
        !!a && n.createElement('div', { className: t.adornEnd }, a)
      )
    }
    t.default = Object(i.destyle)(a, 'BB-FormField')
  },
  function(e, t, r) {
    'use strict'
    r.r(t),
    ...
    var s = function(e) {
      ...
      return n.createElement(
        l,
        o({ className: t.root, onChange: i, value: s }, u)
      )
    }
    t.default = Object(i.destyle)(s, 'BB-Input')
  },
  ,
  ,
  ,
  ...
  function(e, t, r) {
    'use strict'
    var n,
      i = (n = r(0)) && 'object' == typeof n && 'default' in n ? n.default : n,
      o =
        Object.assign ||
        function(e) {
          for (var t = 1; t < arguments.length; t++) {
  ...
  function(e, t, r) {
    ...
    var h = function(e) {
      var t = e.value,
        ...
        h = e.fiatCode,
        p = void 0 === h ? 'USD' : h,
        y = e.onSwitchCurrency,
        v = e.onChange,
        b = e.styles,
        g = (e.destyleMerge, e.formFieldProps),
        m = d(e, [
          'value',
          'editing',
          'nanoFormatted',
        ...
        i.a.createElement(
          ...
          i.a.createElement(
            ...
            i.a.createElement(
              ...
              i.a.createElement(
                'span',
                { className: b.bottomVal },
                'nano' === n ? c : u
              ),
              i.a.createElement(
                'span',
                { className: b.bottomLabel },
                'nano' === n ? p : 'NANO'
              )
            )
          ),
    ...
    t.default = Object(c.destyle)(h, 'BB-AmountField')
  }
])
