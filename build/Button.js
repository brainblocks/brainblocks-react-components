  ...
  function(e, t, r) {
    ...
    var a = function(e) {
        ...
        function u(e, r) {
          ...
          var f = (function e(r, s, u, f, d) {
                  ...
                  case 59:
                    if (
                      ...
                      switch (
                        ...
                        0 < $ &&
                          void 0 !==
                            (k = a(1, G, s, r, P, j, U.length, f, d, f)) &&
                          0 === (W = (G = k.trim()).length) &&
                          (G = '\0\0'),
                        (h = G.charCodeAt(0)),
                        (p = G.charCodeAt(1)),
                ...
                case 10:
                  47 === O
                    ...
                    : 0 === 1 + h &&
                      ...
                      0 < G.length &&
                      ((I = 1), (G += '\0')),
                    0 < $ * T && a(0, G, s, r, P, j, U.length, f, d, f),
                    (j = 1),
                    P++
                  break
                case 59:
            ...
            if (0 < (W = U.length)) {
              if (
                ((I = s),
                0 < $ &&
                  void 0 !== (k = a(2, U, I, r, P, j, W, f, d, f)) &&
                  0 === (U = k).length)
              )
                return H + U + L
              if (((U = I.join(',') + '{' + U + '}'), 0 != M * C)) {
          ...
          return (
            0 < $ &&
              void 0 !== (u = a(-2, f, s, s, P, j, f.length, 0, 0, 0)) &&
              (f = u),
            (C = 0),
            (j = P = 1),
            f
...
*/
  ...
  function(e, t, r) {
    ...
    function z(...e) {
      return [
        `${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${E})`,
        `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${T})`,
