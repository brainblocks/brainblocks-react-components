    ...
    var s = function(e) {
        ...
        function s(e, t, n, r, o, i, s, a, l, c) {
          for (var f, d = 0, p = t; d < T; ++d)
            switch ((f = M[d].call(u, e, p, n, r, o, i, s, a, l, c))) {
              case void 0:
              case !1:
              case !0:
              case null:
        ...
        function u(e, n) {
          ...
          var f = (function e(n, a, u, f, d) {
            for (
              ...
              if (
                ...
                if (
                  $ === U &&
                  (0 < I && (z = z.replace(c, '')), 0 < z.trim().length)
                ) {
                  switch (h) {
                    case 32:
                    case 9:
                ...
                switch (h) {
                  case 123:
                    for (
                      p = (z = z.trim()).charCodeAt(0), y = 1, F = ++$;
                      $ < W;

                    ) {
                      switch ((h = u.charCodeAt($))) {
                        case 123:
                          y++
                          break
                        case 125:
                    ...
                    switch (
                      ((y = u.substring(F, $)),
                      0 === p &&
                        (p = (z = z.replace(l, '').trim()).charCodeAt(0)),
                      p)
                    ) {
                      case 64:
                        switch (
                  ...
                  case 59:
                    if (
                      1 <
                      (F = (z = (0 < I ? z.replace(c, '') : z).trim()).length)
                    )
                      switch (
                        (0 === D &&
                          ((p = z.charCodeAt(0)),
                        ...
                        0 < T &&
                          void 0 !==
                            (k = s(1, z, a, n, P, E, G.length, f, d, f)) &&
                          0 === (F = (z = k.trim()).length) &&
                          (z = '\0\0'),
                        (p = z.charCodeAt(0)),
                        (h = z.charCodeAt(1)),
                        ...
                        default:
                          58 !== z.charCodeAt(F - 1) &&
                            (G += r(z, p, h, z.charCodeAt(2)))
                      }
                    ;(L = I = D = p = 0), (z = ''), (h = u.charCodeAt(++$))
                }
              }
              switch (h) {
                case 13:
                case 10:
                  47 === O
                    ...
                    : 0 === 1 + p &&
                      ...
                      0 < z.length &&
                      ((I = 1), (z += '\0')),
                    0 < T * N && s(0, z, a, n, P, E, G.length, f, d, f),
                    (E = 1),
                    P++
                  break
                case 59:
            ...
            if (0 < (F = G.length)) {
              if (
                ((I = a),
                0 < T &&
                  void 0 !== (k = s(2, G, I, n, P, E, F, f, d, f)) &&
                  0 === (G = k).length)
              )
                return V + G + B
              if (((G = I.join(',') + '{' + G + '}'), 0 != j * C)) {
          ...
          return (
            0 < T &&
              void 0 !== (u = s(-2, f, a, a, P, E, f.length, 0, 0, 0)) &&
              (f = u),
            (C = 0),
            (E = P = 1),
            f
...
*/
  ...
  function(e, t, n) {
    ...
    const G = new Map(),
      B = {},
      V = Object(M.a)({ typography: { suppressWarning: !0 } }),
      H = (e, t = {}) => n => {
        ...
        class h extends u.a.Component {
          constructor(e, t) {
            ...
            n &&
              ...
              (this.theme = p ? T.a.initial(t) || V : B),
          ...
          attach(e) {
            ...
            let n = R.get(this.sheetsManager, t, e)
            if (
              (n ||
                ((n = { refs: 0, sheet: null }),
                R.set(this.sheetsManager, t, e, n)),
              0 === n.refs)
            ) {
              let r
              this.sheetsCache && (r = R.get(this.sheetsCache, t, e)),
                r ||
                  ((r = this.createSheet(e)).attach(),
                  this.sheetsCache && R.set(this.sheetsCache, t, e, r)),
                (n.sheet = r)
          ...
          detach(e) {
            if (this.disableStylesGeneration) return
            const t = R.get(this.sheetsManager, this.stylesCreatorSaved, e)
            if (((t.refs -= 1), 0 === t.refs)) {
              R.delete(this.sheetsManager, this.stylesCreatorSaved, e),
          ...
          render() {
            const e = this.props,
              ...
              l = F({ theme: this.theme, name: a, props: i })
            return (
    ...
    t.a = (e, t) =>
      p.ponyfillGlobal.__MUI_STYLES__.withStyles(e, o()({ defaultTheme: V }, t))
  },
  function(e, t, n) {
    'use strict'
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function(e, t, n) {
    ...
    function T(e, t) {
      const n = 'function' == typeof t ? t(e) : t,
        ...
        g = {
          ...
          buttonNext: b(c, 14, 1.75, 0.4, R),
          captionNext: b(l, 12, 1.66, 0.4),
          overline: b(l, 12, 2.66, 1, R)
        },
        x = {
          display4: o()(
            {
    ...
    t.a = function(e = {}) {
      ...
      return o()(
        ...
        u()({ shape: L, spacing: m, transitions: W.a, zIndex: U }, p, {
  ...
  function(e, t, n) {
    ...
    function _(e) {
      const t = Object(p.a)(e),
        n = Object(S.a)(t)
      if (!O()(t) && (!(r = e) || 'body' !== r.tagName.toLowerCase()))
    ...
    function P(e, t, n, r) {
      ...
      ;[].forEach.call(e.children, e => {
        ;-1 === o.indexOf(e) &&
          (function(e) {
            return 1 === e.nodeType && -1 === E.indexOf(e.tagName.toLowerCase())
          })(e) &&
          r(e)
      })
    }
    ...
    var T = class {
        ...
        add(e, t) {
          ...
          const r = R(this.data, e => e.container === t)
        ...
        mount(e) {
          const t = R(this.data, t => -1 !== t.modals.indexOf(e)),
            n = this.data[t]
          !n.style &&
            ...
            (function(e) {
              ...
              if (e.overflowing) {
                const n = k()()
                t.paddingRight = `${M(e.container) + n}px`
        ...
        remove(e) {
          ...
          if (-1 === t) return t
          const n = R(this.data, t => -1 !== t.modals.indexOf(e)),
            r = this.data[n]
          if (
      ...
      $ = n(86),
      I = n(50)
    const L = { entering: { opacity: 1 }, entered: { opacity: 1 } }
    class F extends u.a.Component {
      constructor(...e) {
        super(...e),
          (this.handleEnter = e => {
      ...
      render() {
        ...
        return u.a.createElement(
          ...
          (e, n) =>
            u.a.cloneElement(t, o()({ style: o()({ opacity: 0 }, L[e], i) }, n))
        )
      }
    }
    F.defaultProps = {
  ...
  function(e, t, n) {
        ...
        o()(
          {
            className: p()(
              n.root,
              { [n.dense]: a && !l, [n.padding]: !l, [n.subheader]: c },
              r
            )
          },
          f
        ),
        u.a.createElement(y.a.Provider, { value: { dense: a } }, c, t)
      )
    }
          ...
          o()(
            {
              role: 'menu',
              ref: e => {
                this.listRef = c.a.findDOMNode(e)
              },
              className: n,
              onKeyDown: this.handleKeyDown,
            ...
            u.a.isValidElement(e)
              ? u.a.cloneElement(e, {
                  ...
                  ref: e.props.selected
                    ? e => {
                        this.selectedItemRef = c.a.findDOMNode(e)
                      }
                    : void 0,
    ...
    b.defaultProps = { disableListWrap: !1 }
    t.a = b
  },
  function(e, t, n) {
    'use strict'
    ...
    function O(e) {
      const {
        ...
        c = w()(t.root, t[`elevation${a}`], { [t.rounded]: !i }, n)
    ...
    class j extends u.a.Component {
      constructor() {
        super(),
          ...
          (this.getPositioningStyle = e => {
            ...
            return { top: `${u}px`, left: `${l}px`, transformOrigin: P(s) }
          }),
      ...
      render() {
        ...
        let j = _
        'auto' !== _ || O.muiSupportAuto || (j = void 0)
        const R = i || (t ? Object(y.a)(C(t)).body : void 0)
        return u.a.createElement(
          g.a,
          o()(
            {
          ...
          u.a.createElement(
            ...
            o()(
              ...
              E,
              { onEntering: Object(v.b)(this.handleEntering, E.onEntering) }
            ),
            u.a.createElement(
              S,
              o()(
  ...
  function(e, t, n) {
    ...
    class b extends o.a.Component {
        ...
        super(...e),
          (this.getContentAnchorEl = () =>
            this.menuListRef.selectedItemRef
              ? c.a.findDOMNode(this.menuListRef.selectedItemRef)
              : c.a.findDOMNode(this.menuListRef).firstChild),
          (this.focus = () => {
            if (this.menuListRef && this.menuListRef.selectedItemRef)
              return void c.a
                .findDOMNode(this.menuListRef.selectedItemRef)
                .focus()
            const e = c.a.findDOMNode(this.menuListRef)
          ...
          (this.handleEntering = e => {
            const { disableAutoFocusItem: t, theme: n } = this.props,
              r = c.a.findDOMNode(this.menuListRef)
            if (
              (!0 !== t && this.focus(),
      ...
      render() {
        ...
        return o.a.createElement(
          ...
          s()(
            {
              ...
              anchorOrigin: 'rtl' === l.direction ? m : v,
              transformOrigin: 'rtl' === l.direction ? m : v,
              PaperProps: s()({}, i, {
                classes: s()({}, i.classes, { root: n.paper })
              })
            },
            c
          ),
          o.a.createElement(
            y.a,
            s()({ onKeyDown: this.handleListKeyDown }, r, {
    ...
    b.defaultProps = { disableAutoFocusItem: !1, transitionDuration: 'auto' }
    var g = Object(p.a)(
        {
          paper: {
    ...
    var S = function(e) {
      var t = e.styles,
        n = e.children,
        o = (e.destyleMerge, O(e, ['styles', 'children', 'destyleMerge']))
        ...
        w(
          {
            ...
            classes: { paper: Object(k.b)(t.root) }
          },
          o
        ),
        n
    ...
    t.default = Object(x.destyle)(S, 'BB-Menu')
  }
])
